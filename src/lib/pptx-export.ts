  ...
  'module-consolidation': [
    {
      ...
      elements: [
        ...
        { type: 'text', content: '🤝 Participation', x: 1.7, y: 3.6, w: 3, h: 0.4, options: { fontSize: 12, color: THEME.textPrimary } },
        { type: 'text', content: '👥 CIF', x: 1.7, y: 4.1, w: 3, h: 0.4, options: { fontSize: 12, color: THEME.textPrimary } },
        ...
        { type: 'text', content: '🤝 Participation', x: 5.7, y: 3.6, w: 3, h: 0.4, options: { fontSize: 12, color: THEME.textPrimary } },
        { type: 'text', content: '👥 CIF', x: 5.7, y: 4.1, w: 3, h: 0.4, options: { fontSize: 12, color: THEME.textPrimary } },
    ...
    },
    {
      ...
      elements: [
        ...
        { type: 'text', content: '🤝 Participation  ⚠️ DUPLICATE', x: 1.7, y: 3.6, w: 3.1, h: 0.4, options: { fontSize: 11, color: THEME.red, bold: true } },
        { type: 'box', content: '', x: 1.6, y: 4, w: 3.3, h: 0.5, options: { fill: { color: 'EF444440' }, line: { color: THEME.red, pt: 1 } } },
        { type: 'text', content: '👥 CIF  ⚠️ DUPLICATE', x: 1.7, y: 4.1, w: 3.1, h: 0.4, options: { fontSize: 11, color: THEME.red, bold: true } },
        ...
        { type: 'text', content: '🤝 Participation  ⚠️ DUPLICATE', x: 5.7, y: 3.6, w: 3.1, h: 0.4, options: { fontSize: 11, color: THEME.red, bold: true } },
        { type: 'box', content: '', x: 5.6, y: 4, w: 3.3, h: 0.5, options: { fill: { color: 'EF444440' }, line: { color: THEME.red, pt: 1 } } },
        { type: 'text', content: '👥 CIF  ⚠️ DUPLICATE', x: 5.7, y: 4.1, w: 3.1, h: 0.4, options: { fontSize: 11, color: THEME.red, bold: true } },
    ...
    },
    {
      ...
      elements: [
        ...
        { type: 'text', content: '🧾 Billing    🤝 Participation    👥 CIF    💰 Pricing', x: 2.2, y: 4.8, w: 6, h: 0.5, options: { fontSize: 12, color: THEME.textPrimary } },
      ],
    },
    {
      ...
      elements: [
        ...
        { type: 'text', content: '🧾 Billing  🤝 Participation  👥 CIF  💰 Pricing', x: 1.9, y: 4.6, w: 4.3, h: 0.4, options: { fontSize: 10, color: THEME.textPrimary } },
  ...
  'trade-architecture': [
    {
      ...
      elements: [
        ...
        { type: 'text', content: '🔧 Shared Components: Billing • CIF • Pricing • Participation', x: 1, y: 4.2, w: 8, h: 0.5, options: { fontSize: 11, color: THEME.accentGold } },
        // Data layer
